"""Unit tests for SILMA TTS model manager behavior."""
...
class TestTTSModelManager:
    def test_synthesize_passes_force_tashkeel_to_infer(self, tmp_path):
        ...
        from app.model import TTSModelManager
        ...
        with patch.object(manager, "load_model", return_value=dummy_model), patch.object(
