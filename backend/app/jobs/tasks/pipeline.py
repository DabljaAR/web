"""Segment processing utility functions.

The Celery-based TTS pipeline (tts_synthesize_segment, tts_combine_results)
has been replaced by the tts-service microservice (RabbitMQ consumer).
Only the pure utility functions remain for use in tests and configuration.
"""
import logging
import re
