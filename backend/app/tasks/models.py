...
class VideoTask(Base):
    ...
    processing_mode: Mapped[str] = mapped_column(String(20), nullable=False, default="single")
    ...
    stt_segments: Mapped[Optional[list]] = mapped_column(JSON, nullable=True)
    ...
    # TTS combined output — object-storage key for the merged audio file
